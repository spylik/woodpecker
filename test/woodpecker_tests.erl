            ...
            [
                ...
                {<<"Must do not respect requests_allowed_by_api/requests_allowed_in_period for urgent priority requests">>,
                    fun() ->
                        ...
                        [?TESTMODULE:get(Server,lists:append(["/?query=",integer_to_list(QueryParam)]),'urgent') || _A <- lists:seq(1,SendReq)],
                        timer:sleep(20),
                        Tasks = ets:tab2list(ETSTable),
                ...
                {<<"Must respect requests_allowed_by_api/requests_allowed_in_period for high priority requests">>,
                    fun() ->
                        ...
                        ETSTable = woodpecker:generate_ets_name(Server),
                        ?TESTMODULE:start_link(#woodpecker_state{server = Server, connect_to = ?TESTHOST, connect_to_port = ?TESTPORT, report_to = WaitAt, heartbeat_freq = 10000, requests_allowed_in_period = Requests_allowed_in_period, requests_allowed_by_api = Requests_allowed_by_api}),
                        [?TESTMODULE:get(Server,lists:append(["/?query=",integer_to_list(QueryParam)]),'high') || _A <- lists:seq(1,SendReq)],
                        timer:sleep(20),
                        Tasks = ets:tab2list(ETSTable),
                        ?assertEqual(SendReq, length(Tasks)),
                        Tst = ets:select(ETSTable,[{{wp_api_tasks,'_','_',high,'_','_','_','_','_','_','_','_','$2','$1','_'},[{'<','$1',10},{'<','$1','$2'}],['$_']}]),
                ...
                {<<"If we overquoted during 'urgent' tasks, wp must do not process requests with 'high' priority until will have quota">>,
                    fun() ->
                        ...
                        Tst1 = ets:select(ETSTable,[{{wp_api_tasks,'_','_',urgent,'_','_','_','_','_','_','_','_','$2','$1','_'},[{'<','$1',10},{'<','$1','$2'}],['$_']}]),
                        ?assertEqual(SendReq, length(Tst1)),
                        Tst2 = ets:select(ETSTable,[{{wp_api_tasks,'_','new',high,'_','_','_','_','_','_','_','_','$2','$1','_'},[{'<','$1',10},{'<','$1','$2'}],['$_']}]),
                        Tst3 = ets:select(ETSTable,[{{wp_api_tasks,'_','_',high,'_','_','_','_','_','_','_','_','$2','$1','_'},[{'<','$1',10},{'<','$1','$2'}],['$_']}]),
                ...
                {<<"Must respect requests_allowed_by_api/requests_allowed_in_period for normal priority requests">>,
                    fun() ->
                        ...
                        ETSTable = woodpecker:generate_ets_name(Server),
                        ?TESTMODULE:start_link(#woodpecker_state{server = Server, connect_to = ?TESTHOST, connect_to_port = ?TESTPORT, report_to = WaitAt, heartbeat_freq = 10000, requests_allowed_in_period = Requests_allowed_in_period, requests_allowed_by_api = Requests_allowed_by_api}),
                        [?TESTMODULE:get(Server,lists:append(["/?query=",integer_to_list(QueryParam)]),'normal') || _A <- lists:seq(1,SendReq)],
                        timer:sleep(20),
                        Tasks = ets:tab2list(ETSTable),
                        ?assertEqual(SendReq, length(Tasks)),
                        Tst = ets:select(ETSTable,[{{wp_api_tasks,'_',new,normal,'_','_','_','_','_','_','_','_','$2','$1','_'},[{'<','$1',10},{'<','$1','$2'}],['$_']}]),
                        ?assertEqual(SendReq, length(Tst)),
                         Server ! 'heartbeat',
                        timer:sleep(5),
                        Tst2 = ets:select(ETSTable,[{{wp_api_tasks,'_',new,normal,'_','_','_','_','_','_','_','_','$2','$1','_'},[{'<','$1',10},{'<','$1','$2'}],['$_']}]),
                ...
                {<<"Must respect requests_allowed_by_api/requests_allowed_in_period for low priority requests">>,
                    fun() ->
                        ...
                        ETSTable = woodpecker:generate_ets_name(Server),
                        ?TESTMODULE:start_link(#woodpecker_state{server = Server, connect_to = ?TESTHOST, connect_to_port = ?TESTPORT, report_to = WaitAt, heartbeat_freq = 10000, requests_allowed_in_period = Requests_allowed_in_period, requests_allowed_by_api = Requests_allowed_by_api}),
                        [?TESTMODULE:get(Server,lists:append(["/?query=",integer_to_list(QueryParam)]),'low') || _A <- lists:seq(1,SendReq)],
                        timer:sleep(20),
                        Tasks = ets:tab2list(ETSTable),
                        ?assertEqual(SendReq, length(Tasks)),
                        Tst = ets:select(ETSTable,[{{wp_api_tasks,'_',new,low,'_','_','_','_','_','_','_','_','$2','$1','_'},[{'<','$1',10},{'<','$1','$2'}],['$_']}]),
                        ?assertEqual(SendReq, length(Tst)),
                         Server ! 'heartbeat',
                        timer:sleep(5),
                        Tst2 = ets:select(ETSTable,[{{wp_api_tasks,'_',new,low,'_','_','_','_','_','_','_','_','$2','$1','_'},[{'<','$1',10},{'<','$1','$2'}],['$_']}]),
                        ?assertEqual(SendReq, length(Tst2)+Requests_allowed_by_api),
